...
router.put('/users/:id', 
  ...
  async (req: Request, res: Response) => {
    try {
      // Ne pas autoriser la mise à jour du mot de passe via cette route
...
// routes/admin.ts (continuation)
      // Empêcher le retrait du dernier rôle d'un utilisateur
      ...
      // Empêcher le retrait du rôle admin de son propre compte
...
router.get('/dashboard', 
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      // Plus de statistiques pourraient être ajoutées ici selon vos besoins
